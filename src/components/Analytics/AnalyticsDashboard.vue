        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-xl">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold">{{ stats?.wordsRecorded || 0 }}</p>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-xl">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold">{{ stats?.reviewsCompleted || 0 }}</p>
              <div class="flex items-center mt-2">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                </svg>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-xl">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold">{{ formatStudyTime(stats?.totalStudyTime || 0) }}</p>
              <div class="flex items-center mt-2">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                </svg>
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              ...
              <div class="text-right">
                <div class="font-bold text-green-600">{{ masteryStats?.mastered || 0 }}</div>
            ...
            <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              ...
              <div class="text-right">
                <div class="font-bold text-blue-600">{{ masteryStats?.inProgress || 0 }}</div>
            ...
            <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
              ...
              <div class="text-right">
                <div class="font-bold text-red-600">{{ masteryStats?.struggling || 0 }}</div>
          ...
          <div v-if="bestStudyTime" class="text-center">
            ...
            <div class="bg-blue-50 p-3 rounded-lg">
              <div class="text-sm text-blue-700">
                平均正确率: {{ (bestStudyTime.performance * 100).toFixed(1) }}%
              </div>
              <div class="text-sm text-blue-600">
                学习次数: {{ bestStudyTime.sessionCount }}
              </div>
            </div>
          </div>
      ...
      <div v-if="achievements && achievements.length > 0" class="mb-8">
        ...
        <div class="flex flex-wrap gap-4">
          ...
          >
            ...
            <div>
              <div class="font-medium text-yellow-800">{{ achievement.title }}</div>
              <div class="text-sm text-yellow-600">{{ achievement.description }}</div>
              <div class="text-xs text-yellow-500">{{ formatDate(achievement.unlockedAt) }}</div>
            </div>
          </div>
        </div>
      </div>
...
const masteryPercentage = computed(() => {
  ...
  return {
    ...
    notReviewed: (((total - (masteryStats.value?.mastered || 0) - (masteryStats.value?.inProgress || 0) - (masteryStats.value?.struggling || 0)) / total) * 100).toFixed(1)
  }
})
